...
- **Instructive**: When you output code for an MCP component, briefly describe *why* that specific primitive or pattern is used according to the official documentation.
